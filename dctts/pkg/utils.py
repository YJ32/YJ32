...
def spectrogram2wav(mag):
    ...
    # to amplitude : np.power(10,3) 이면 10의 3승
...
## text_lengths : 배열 / wav의 txt를 숫자로 표현한 배열의 크기 ex)[2,3]
## mel_lengths : int
def guide_attention(text_lengths, mel_lengths, r=None, c=None):
    ...
    for i in range(b):
        ##guide에 1로 채워진 [r,c] 배열 b개 중에 i번째 배열 W에
        W = guide[i]
        M = mask[i]
